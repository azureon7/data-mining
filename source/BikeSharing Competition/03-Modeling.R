library(Metrics); library(caret); library(randomForest)
...
write.table(pred.cnt4, file = "./predictions/pred4_100semi.txt", row.names = F, col.names = F)
...
write.table(pred.cnt6, file = "./predictions/pred6_100semi.txt", row.names = F, col.names = F)
...
write.table(pred.cnt8, file = "./predictions/pred8_100semi.txt", row.names = F, col.names = F)
...
write.table(pred.cnt9, file = "./predictions/pred9_100semi.txt", row.names = F, col.names = F)
