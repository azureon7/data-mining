...
d1 <- read.csv("http://bee-fore.s3-eu-west-1.amazonaws.com/datasets/60.csv", stringsAsFactors = F)
d2 <- read.csv("http://bee-fore.s3-eu-west-1.amazonaws.com/datasets/61.csv", stringsAsFactors = F)
...
#==================
# lm
formula <- log10(SalePrice+1)~ Gr.Liv.Area+Total.Bsmt.SF+Kitchen.Qual+
...
ypred.lm <- 10^predict(fit1, newdata=dtest[dtest$Bsmt.Qual!=0,])-1
